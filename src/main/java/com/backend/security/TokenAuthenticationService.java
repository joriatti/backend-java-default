...
public class TokenAuthenticationService {
    ...
    private static String jwtSecretSign;

    private static final long EXPIRATIONTIME = 864000000; // 240 horas
    ...
    public static void addAuthentication(HttpServletResponse res, String username) {
        String JWT = Jwts.builder()
                ...
                .signWith(io.jsonwebtoken.SignatureAlgorithm.HS512, jwtSecretSign)
                .compact();
